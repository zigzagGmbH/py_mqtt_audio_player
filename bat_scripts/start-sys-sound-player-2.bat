...
echo Starting config-music-1 player...

:: Start player: (Update if different)
start /b "" "%UV_PATH%" run main.py -c config-sys-sound-2.yaml


echo config-music-1 started !