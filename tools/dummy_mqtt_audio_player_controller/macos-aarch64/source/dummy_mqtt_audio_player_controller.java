/* autogenerated by Processing revision 1304 on 2025-06-19 */
...
public class dummy_mqtt_audio_player_controller extends PApplet {
...
// UI Callbacks
public void player_toggle(boolean flag) {
  uiManager.onPlayerToggle(flag);
}

public void session_toggle(boolean flag) {
  uiManager.onSessionToggle(flag);
}

public void loop_toggle(boolean flag) {
  uiManager.onLoopToggle(flag);
}

public void volume_slider(float value) {
  uiManager.onVolumeSlider(value);
}

public void send_audio_url() {
  uiManager.onSendAudioUrl();
}

public void mqtt_toggle(boolean flag) {
  uiManager.onMqttToggle(flag);
}

public void audio_tracker(float value) {
  uiManager.onAudioTracker(value);
}


public void ch_1(boolean flag) {
  uiManager.onChannelToggle(flag);
}
public void ch_2(boolean flag) {
  uiManager.onChannelToggle(flag);
}
public void ch_3(boolean flag) {
  uiManager.onChannelToggle(flag);
}
public void ch_4(boolean flag) {
  uiManager.onChannelToggle(flag);
}
public void ch_5(boolean flag) {
  uiManager.onChannelToggle(flag);
}
public void ch_6(boolean flag) {
  uiManager.onChannelToggle(flag);
}
public void ch_7(boolean flag) {
  uiManager.onChannelToggle(flag);
}
public void ch_8(boolean flag) {
  uiManager.onChannelToggle(flag);
}
public void ch_9(boolean flag) {
  uiManager.onChannelToggle(flag);
}
public void ch_10(boolean flag) {
  uiManager.onChannelToggle(flag);
}
public void ch_11(boolean flag) {
  uiManager.onChannelToggle(flag);
}
public void ch_12(boolean flag) {
  uiManager.onChannelToggle(flag);
}
public void ch_13(boolean flag) {
  uiManager.onChannelToggle(flag);
}
public void ch_14(boolean flag) {
  uiManager.onChannelToggle(flag);
}
public void ch_15(boolean flag) {
  uiManager.onChannelToggle(flag);
}
public void ch_16(boolean flag) {
  uiManager.onChannelToggle(flag);
}
...
class AudioTracker {
  ...
  public void handleAudioPositionUpdate(JSONObject json) {
    ...
    try {
      ...
      float receivedPercentage = json.getFloat("percentage", 0.0f);
...
class LevelVisualizer {
  ...
  private float peakAudioLevel = 0.0f;
  ...
  private void drawLevelMeter() {
    ...
    // Calculate segments
    int activeSegments = PApplet.parseInt(smoothedAudioLevel * numSegments);
    int peakSegment = LEVEL_METER_PEAK_HOLD ? PApplet.parseInt(peakAudioLevel * numSegments) : 0;
  ...
  private int getSegmentColor(int segment, int numSegments, boolean dimmed) {
    int alpha = dimmed ? 128 : 255;

    if (segment < (numSegments * 0.6f)) {
      return color(0, alpha, 0); // Green
    } else if (segment < numSegments * 0.8f) {
...
class UIManager {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "dummy_mqtt_audio_player_controller" };
    if (passedArgs != null) {
